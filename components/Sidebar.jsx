...
const Sidebar = ({ view, setView, setGlobalPlaylistId }) => {
    ...
    return (
        ...
        sm:max-w-[12rem] lg:min-w-[14rem] lg:max-w-[15rem] hidden md:inline-flex space-y-2 flex-col pb-40'>
            ...
            <button onClick={() => setView('home')} className={`flex items-center space-x-3 cursor-pointer hover:bg-neutral-800 hover:text-white transition-colors duration-200 rounded p-2
            ${view === 'home' ? 'bg-neutral-800 text-white' : 'hover:bg-neutral-800 hover:text-white'}`}>
                <IconHome className='h-5 w-5'/>
                <p>Home</p>
            </button>
            <button className={`flex items-center space-x-3 cursor-pointer hover:bg-neutral-800 hover:text-white transition-colors duration-200 rounded p-2`}>
                ...
                {!loading && !error && userPlaylists.length > 0 && (
                    userPlaylists.map((playlist, i) => (
                        <Button 
                            ...
                            className='w-full flex items-center space-x-2 cursor-pointer hover:bg-neutral-800 hover:text-white transition-colors duration-200 rounded p-2'
                        >
